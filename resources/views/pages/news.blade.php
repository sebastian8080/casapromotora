            ...
            <div class="row">
                ...
                <div class="row g-0">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">{{$post->metadescripcion}}</p>

                        <a href="{{ route('web.show.post',$post->slug) }}" class="btn" style="background-color: #670C07; color: white;" border-radius: 5px>LEER BLOG</a>
