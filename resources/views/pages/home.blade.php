        ...
        <div class="col-sm-6">
          <div class="carrusel m-4">
            <div id="carouselExampleControls2" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img id="imgBanner1" src="{{ asset('img/projects/adra/1.webp') }}" class="d-block img-fluid" width="100%" alt="Departamentos Adra - Cuenca Casa Credito Promotora">
                ...
                <div class="carousel-item">
                  <img id="imgBanner2" src="{{ asset('img/projects/futuranarancay/1.webp') }}" class="d-block img-fluid" width="100%" alt="Departamentos Futura Narancay - Cuenca Casa Credito Promotora">
                  <div class="carousel-caption d-md-block">
                ...
                <div class="carousel-item">
                  <img id="imgBanner3" src="{{ asset('img/projects/toscana/1.webp') }}" class="d-block img-fluid" width="100%" alt="Condominios Toscana - Cuenca">
                  <div class="carousel-caption d-md-block">
