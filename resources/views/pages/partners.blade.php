...
@section('content')
        ...
        <div class="row pt-5 mt-5">
            <div class="col-sm-7 text-center">
                <img class="img-fluid rounded" style="width: 80%" src="img/partners/COOP-LOS-RIOS.jpg" alt="Imagen Banco Pichincha">
            </div>
    ...
    <div class="row mb-5 pb-5 text-secondary" style="margin-left: 5%; margin-right: 10%">
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="card mb-4 hover-zoomin" style="width: 18rem;" data-aos="zoom-in">
