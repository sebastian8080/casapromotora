  ...
  <!--NAVBAR-->
    <nav id="menu" class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="{{ route('pages.home') }}"><img src="{{ URL::asset('casacredito-logo.png'); }}" alt=""></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul id="itemMenu" class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="{{ route('pages.about') }}">NOSOTROS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('pages.projects') }}">PROYECTOS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('pages.news') }}">NOTICIAS</a>
              </li>
            ...
            <div class="row mt-3">
              <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-4">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  <p style="text-align: right" class="fw-bold">ventas@casacreditopromotora.com</p>
                  <p style="text-align: right" class="fw-bold">1800 CASACREDITO</p>
                  <p style="text-align: right">WEB BY CASA CREDITO PRO</p>
                </div>
              </div>
            </div>
          </section>
