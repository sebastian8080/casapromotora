  ...
  <!--NAVBAR-->
    <nav id="menu" class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="container-fluid">
          ...
          <button id="btn-collapse-navbar" class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <ul id="itemMenu" class="navbar-nav rounded">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item" href="#">Arquitectos</a></li>
                  <li><a class="dropdown-item" href="#">Remodelaciones</a></li>
                  <li><a class="dropdown-item" href="#">Construye</a></li>
                </ul>
              </li>
              <li class="nav-item">
