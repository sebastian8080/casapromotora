...
Route::get('/search', [IndexController::class, 'searchProperties'])->name('search');
Route::get('/proyecto/{project_name}', [ProjectController::class, 'showprojectbyname'])->name('show.project.by.name');
